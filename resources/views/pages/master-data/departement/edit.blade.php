...
@section('content')
    <div class="max-w-md mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-5 border-b border-gray-100 flex justify-between items-center">
            <h3 class="text-sm font-bold text-gray-800">Edit Data Departement</h3>
        ...
        <form action="{{ route('departement.update', $departement->id) }}" method="POST" onsubmit="disableSubmitButton()"
            class="p-6 space-y-4">
            @csrf
            @method('PUT')
