...
@section('content')
    <div class="max-w-2xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        {{-- Form --}}
        <form action="{{ route('kpi-criteria.store') }}" method="POST" onsubmit="disableSubmitButton()" class="p-6 space-y-5">
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="4"
                    class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#0a855c]">{{ old('deskripsi') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="bobot" min="0" max="100" value="{{ old('bobot') }}" required
                        class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#0a855c]">
                ...
                <div>
                    ...
                    <select name="metode_ukur" required
                        ...
                        <option value="percentage" {{ old('metode_ukur') == 'percentage' ? 'selected' : '' }}>
                            Persentase
                        </option>

                        <option value="sudah_belum" {{ old('metode_ukur') == 'sudah_belum' ? 'selected' : '' }}>
                            Sudah / Belum
                        </option>
            ...
            <div>
                ...
                <select name="jenis_tunjangan" required
                    ...
                    <option value="tunjangan_kedisiplinan"
                        {{ old('jenis_tunjangan') == 'tunjangan_kedisiplinan' ? 'selected' : '' }}>
                        Tunjangan Kedisiplinan
                    </option>

                    <option value="tunjangan_performa"
                        {{ old('jenis_tunjangan') == 'tunjangan_performa' ? 'selected' : '' }}>
                        Tunjangan Performa
                    </option>
            ...
            <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                ...
                <a href="{{ route('kpi-criteria.position', $position->id) }}"
